...
import { ancientSpriteWand, EnergySword, Hammer, Microphone, RockArmor, ScoopingNet, Spear, SuperNova, Weapon } from "./weapons"
import { AtkUp, CriticalMaster, DefUp, FireMaster, GroundMaster, HealMaster, PhysicMaster, PoisonMaster, WaterMaster, HealthMaster, Blessing } from "./blessings"
import { Item, Meat, Protect } from "./items"
...
export interface Event {
  ...
  story: string
  dependences: (Weapon | Item | Blessing)[]
}
...
export const rareEvents: Event[] = [
  ...
  },
  {
    ...
    dependences: [new CriticalMaster()]
  }
]
...
export const legendEvents: Event[] = [
  ...
  },
  {
    ...
    dependences: [new ancientSpriteWand()]
  }
]
